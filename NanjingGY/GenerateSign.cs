...
namespace NanjingGY
{
    internal class GenerateSign
    {
        ...
        public string Sign(string url, string body)
        {
            string secretKey = ConfigurationManager.AppSettings["Key"].ToString();
